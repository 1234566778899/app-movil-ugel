...
const EditMonitorDirectivoScreen = ({ navigation }) => {
    const w = 60;
                ...
                <View style={{ flexDirection: 'row', marginTop: 30, gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
                    {
                        currentEdit.performances[currentDesempenio].aspectos.map((aspect, index) => (
                            <TouchableOpacity key={index} onPress={() => navigation.push('edit-performance-directivo', { currentDesempenio: currentDesempenio, currentAspecto: index })}
...
export default EditMonitorDirectivoScreen;